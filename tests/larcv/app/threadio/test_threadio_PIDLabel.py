...
@pytest.mark.parametrize('make_copy', [True, False])
@pytest.mark.parametrize('batch_size', [2])
def test_particle_threadio_distributed(tmpdir, num_threads, num_storage, make_copy, batch_size, n_reads=10):
...
if __name__ == "__main__":
    ...
    # test_particle_threadio_distributed("./", num_threads=1, num_storage=2, make_copy=False, batch_size=2, n_reads=10)
    print("Success")
