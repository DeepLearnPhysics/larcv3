...
@pytest.mark.parametrize('n_projections', [1,2])
def test_sparsetensor2d_threadio_distributed(tmpdir, num_threads, num_storage, make_copy, batch_size, n_projections, n_reads=10):
...
if __name__ == "__main__":
    ...
    # test_sparsetensor2d_threadio_distributed("./", num_threads=1, num_storage=2, make_copy=False, batch_size=2, n_projections=2, n_reads=10)
    print("Success")
