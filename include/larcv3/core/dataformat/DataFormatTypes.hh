/**
 * @file DataFormatTypes.hh
 * @ingroup core_DataFormat
 * @brief Class def header for a class larcv3::DataFormatTypes
 * @author 
 */
#pragma once
...
namespace larcv3 
{
	...
	namespace chstatus 
	{
		...
		/// Channel not reco-ed due to pedestal < 0      
	...
	/// "ID" of MCParticles in terms of its G4 track ID 
	/// (unless mixing multiple MC samples)
	...
	/// ProducerID_t to identify a unique data product within a process 
	/// (for larcv3::IOManager)
	typedef size_t ProducerID_t;
	/// ProductName_t to identify a unique data product within a process 
	///	(for larcv3::IOManager)
