...
namespace larcv3
{
	 ...
	 * 
	 */
	/// TODO: Add USE_HDF5 compiler initiatives for this class
	...
	public:
		...
		std::shared_ptr<EventBase> get_data(const std::string& type, 
		...
		const EventID& last_event_id() const 
	...
	protected:
		...
		// Output groups.  Since these are stored and need to be initialized, 
		// this is a member:
